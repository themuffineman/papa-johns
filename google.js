...
async function getLeads(){
    ...
    try {
        ...
        intermidaryCollection = client.db('pendora').collection('intermidiary')
        ...
        startingCity && startingPage && await locationCollection.updateOne({ $set: { index: startingCity, page: startingPage }})
        await browser.close();
    }
